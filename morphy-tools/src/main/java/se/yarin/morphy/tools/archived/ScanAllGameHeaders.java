...
public class ScanAllGameHeaders {
  ...
  public static void main(String[] args) throws IOException {
    //        Files.walk(Paths.get("testbases/tmp/Move data
    // fragmentation/testing.cbh")).forEach(filePath -> {
    ...
    Files.walk(Paths.get("testbases/CHESS LITERATURE 3"))
        .forEach(
            filePath -> {
              ...
              if (Files.isRegularFile(filePath) && filePath.toString().endsWith(".cbh")) {
                ...
                try {
                  ...
                  //                    if (!map.containsKey(value)) map.put(value, new
                  // ArrayList<>());
