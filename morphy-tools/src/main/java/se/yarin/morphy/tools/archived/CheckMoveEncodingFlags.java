...
public class CheckMoveEncodingFlags {
  ...
  private static ByteBuffer getMoves(FileChannel movesFiles, int ofs)
      throws IOException, ChessBaseInvalidDataException {
        ...
        .forEach(
            filePath -> {
              if (Files.isRegularFile(filePath)
                  && filePath.toString().toLowerCase().endsWith(".cbh")) {
  ...
  private static Map<Integer, List<Integer>> mergeDistribution(
      Map<Integer, List<Integer>> a, Map<Integer, List<Integer>> b) {
  ...
  private static Map<Integer, List<Integer>> getEncodingFlagDistribution(String fileBase)
      throws IOException {
