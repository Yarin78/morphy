...
export const SORTABLE_COLUMN_MAP: Record<EntityType, Record<string, string>> = {
  ...
  Tournaments: { id: 'id', title: 'title', startDate: 'startDate', place: 'place', typeCombined: 'combinedType', nation: 'nation', category: 'category', rounds: 'rounds', gameCount: 'count', complete: 'complete' },
