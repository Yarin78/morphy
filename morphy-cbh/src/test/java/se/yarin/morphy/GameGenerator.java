...
public class GameGenerator {
  ...
  private static final String[] tournaments =
      new String[] {
  ...
  private static final String[] sources =
      new String[] {"CBM 173", "CBM 172", "CBM 171", "CBM 170", "CBM 169", "CBM 168"};
  ...
  /**
   * Adds extra random moves to an existing game at random nodes in the game tree, creating
   * variations
   *
  ...
  public void addRandomAnnotations(GameMovesModel model, int noAnnotations) {
    ...
    while (noAnnotations > 0) {
      ...
      switch (random.nextInt(12)) {
        case 0, 1, 2, 3 ->
            annotation = ImmutableTextAfterMoveAnnotation.of(randomString(random.nextInt(15) + 3));
        case 4 ->
            annotation = ImmutableTextBeforeMoveAnnotation.of(randomString(random.nextInt(15) + 3));
        case 5, 6, 7, 8 ->
            annotation = ImmutableSymbolAnnotation.of(NAG.values()[1 + random.nextInt(6)]);
        case 9 -> {
          ...
          for (int i = 0; i < cnt; i++) {
            GraphicalAnnotationColor color =
                GraphicalAnnotationColor.values()[2 + random.nextInt(3)];
        ...
        case 11 ->
            annotation =
                ImmutableCriticalPositionAnnotation.of(
                    CriticalPositionAnnotation.CriticalPositionType.OPENING);
      }
