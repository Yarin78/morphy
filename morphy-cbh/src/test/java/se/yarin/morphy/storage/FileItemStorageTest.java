...
public class FileItemStorageTest {
    ...
    private File initStorage() throws IOException {
        ...
        FileItemStorage<FooBarItemHeader, FooBarItem> storage = new FileItemStorage<>(file, new FooBarItemSerializer(), FooBarItemHeader.empty(), Set.of(READ, WRITE, CREATE_NEW));
    ...
    public void updateHeader() throws IOException {
        ...
        storage = new FileItemStorage<>(file, new FooBarItemSerializer(), FooBarItemHeader.empty(), Set.of(READ));
        assertEquals(ImmutableFooBarItemHeader.of(9, 13), storage.getHeader());
    }

    @Test
    public void getItem() throws IOException {
        FileItemStorage<FooBarItemHeader, FooBarItem> storage = new FileItemStorage<>(initStorage(), new FooBarItemSerializer(), FooBarItemHeader.empty(), Set.of(READ));
    ...
    public void getItemsOutsideRangeLaxMode() throws IOException {
        FileItemStorage<FooBarItemHeader, FooBarItem> storage = new FileItemStorage<>(initStorage(), new FooBarItemSerializer(), FooBarItemHeader.empty(), Set.of(READ, IGNORE_NON_CRITICAL_ERRORS));
