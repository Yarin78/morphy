...
public class InMemoryBlobStorageTest {
    ...
    public void testGetBlobsFromStorageWithShortHeader() throws IOException {
        ByteBuffer buf = ResourceLoader.loadResource(FileBlobStorage.class, "shortheader.blobstorage.bin");
        InMemoryBlobStorage storage = new InMemoryBlobStorage(buf, new FileBlobStorageTest.StringBlobSizeRetriever());
