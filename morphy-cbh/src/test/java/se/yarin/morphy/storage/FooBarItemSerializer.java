...
public class FooBarItemSerializer implements ItemStorageSerializer<FooBarItemHeader, FooBarItem> {
  ...
  @Override
  public @NotNull FooBarItemHeader deserializeHeader(@NotNull ByteBuffer buf)
  ...
  public void serializeItem(
      @NotNull FooBarItem fooBarItem, @NotNull ByteBuffer buf, @NotNull FooBarItemHeader header) {
