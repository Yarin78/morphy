...
public abstract class DatabaseTestSetup {
  ...
  // 15. Carlsen - So, tour1
  // All move blobs are 100 bytes; annotation blobs are 2000 bytes where there is an annotator
  ...
  protected long wastedAnnotationBytes() {
  ...
  protected Game putTestGame(
      @NotNull DatabaseWriteTransaction txn,
      int gameId,
  ...
  protected Game putTestGame(
    ...
    gameAdapter.setEntityIds(header, extendedHeader, headerModel);
    txn.resolveEntities(header, extendedHeader, headerModel);
