...
public class GameQuotationAnnotationTest {
  @Test
  public void testDeserializeGameQuotation() throws IOException, MorphyInvalidDataException {
  ...
  public void testSerializeDeserializeGameQuotation() {
    ...
    model
        ...
        .parent()
        .addMove(C7, C5);
    model.moves().root().mainNode().addAnnotation(ImmutableSymbolAnnotation.of(NAG.GOOD_MOVE));
