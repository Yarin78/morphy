...
public class RatingRangeFilterTest {
    ...
    public void testFilterRangeAverage() {
        RatingRangeFilter filter = new RatingRangeFilter(2750, 9999, RatingRangeFilter.RatingColor.AVERAGE);
    ...
    public void testFilterRangeBoth() {
        RatingRangeFilter filter = new RatingRangeFilter(2600, 2700, RatingRangeFilter.RatingColor.BOTH);
    ...
    public void testFilterRangeDifference() {
        RatingRangeFilter filter = new RatingRangeFilter(150, 9999, RatingRangeFilter.RatingColor.DIFFERENCE);
