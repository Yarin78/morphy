...
public class AnnotationSerializerTest {
  ...
  public void testChessBaseSymbolAnnotation() {
    SymbolAnnotation before =
        ImmutableSymbolAnnotation.of(
            NAG.DUBIOUS_MOVE, NAG.EDITORIAL_COMMENT, NAG.BLACK_SLIGHT_ADVANTAGE);
  ...
  public void testCriticalPositionAnnotationSerialization() {
    CriticalPositionAnnotation before =
  ...
  public void testGraphicalSquaresAnnotationSerialization() {
    GraphicalSquaresAnnotation before =
  ...
  public void testMedalAnnotationSerialization() {
    MedalAnnotation before =
        ImmutableMedalAnnotation.of(EnumSet.of(Medal.DECIDED_TOURNAMENT, Medal.ENDGAME));
  ...
  public void testTextAfterMoveAnnotationSerialization() {
    TextAfterMoveAnnotation before =
  ...
  public void testTextBeforeMoveAnnotationSerialization() {
    TextBeforeMoveAnnotation before =
        ImmutableTextBeforeMoveAnnotation.builder().text("foobar").language(Nation.ENGLAND).build();
  ...
  public void testTimeControlAnnotationSerialization() {
    TimeControlAnnotation before =
        ImmutableTimeControlAnnotation.of(
            Arrays.asList(
