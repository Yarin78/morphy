...
public class MoveSerializerTest {
  public static MoveSerializer movesSerializer;
  ...
  @Test
  public void parseSimpleGame() throws IOException, MorphyException {
    ByteBuffer buf = ResourceLoader.loadResource(MoveSerializerTest.class, "simplegame.moves.bin");
  ...
  @Test
  public void parseSpecialMoves() throws IOException, MorphyException {
    ByteBuffer buf =
        ResourceLoader.loadResource(MoveSerializerTest.class, "specialmoves.moves.bin");
    GameMovesModel model = movesSerializer.deserializeMoves(buf);
    assertEquals(
        "1.e4 e6 2.e5 d5 3.exd6 Nf6 4.d4 Be7 5.Nc3 O-O 6.Bg5 -- 7.Qd2 a6 8.O-O-O b5 9.dxe7 Kh8 10.exd8=N",
        model.toString());
  ...
  @Test
  public void parseVariations() throws IOException, MorphyException {
    ByteBuffer buf = ResourceLoader.loadResource(MoveSerializerTest.class, "variations.moves.bin");
    GameMovesModel model = movesSerializer.deserializeMoves(buf);
    assertEquals(
        "1.e4 c5 (1...e6 2.d4 d5 3.Nc3 (3.Nd2; 3.e5 c5 4.c3 Nc6 5.Nf3 Bd7 (5...Qb6)) 3...Nf6 4.Bg5 Bb4 (4...Be7 5.e5); 1...Nf6 2.e5 Nd5 3.Nc3 (3.d4) 3...Nxc3 4.dxc3) 2.Nf3 d6 3.d4 cxd4 4.Nxd4 Nf6 5.Nc3 g6 (5...a6 6.Bg5 e6 7.Qd2 (7.f4 Nbd7 8.Qf3) 7...Nbd7; 5...Nc6 6.Bg5 e6 7.Qd2)",
        model.toString());
  ...
  @Test
  public void parseSetup() throws IOException, MorphyException {
    ByteBuffer buf = ResourceLoader.loadResource(MoveSerializerTest.class, "setup.moves.bin");
    GameMovesModel model = movesSerializer.deserializeMoves(buf);
    assertEquals(
        ".....r..|.p...p..|pPbk....|P.N....P|..K.....|........|....R...|........|",
        model.root().position().toString("|"));
  ...
  @Test
  public void parseManyIdenticalPieces() throws IOException, MorphyException {
    ByteBuffer buf =
        ResourceLoader.loadResource(MoveSerializerTest.class, "manyidenticalpieces.moves.bin");
    GameMovesModel model = movesSerializer.deserializeMoves(buf);
    assertEquals(
        "1.Qcd7 Ne4 2.Qf6 Nd5 3.Qhe5 Nf5 4.Qbc5 Ncd4 5.Qb3 Ne6 6.Qed4 Nexd4 7.Qfxd4 N3xd4 8.Qxd4 Nxd4 9.Qf5 Nd6 10.Qbxd5+ Nf7 11.Qfxf7+ Kh8 12.Qxd4#",
        model.toString());
  ...
  @Test
  public void parseMoreIdenticalPieces() throws IOException, MorphyException {
    ByteBuffer buf =
        ResourceLoader.loadResource(MoveSerializerTest.class, "moreidenticalpieces.moves.bin");
    GameMovesModel model = movesSerializer.deserializeMoves(buf);
    assertEquals(
        "1.Rb1 Bbd5 2.Rdc1 Bf4 3.Red1 Bf5 4.Rfe1 Beg5 5.Rgf1 Bh5 6.Na3 Qa8 7.Nb3 Qcb7 8.Nc3 Qdb6 9.Nd3 Qeb5 10.Ne3 Qfg7",
        model.toString());
  ...
  @Test
  public void parsePawnPromotions() throws IOException, MorphyException {
    ByteBuffer buf =
        ResourceLoader.loadResource(MoveSerializerTest.class, "pawnpromotions.moves.bin");
    GameMovesModel model = movesSerializer.deserializeMoves(buf);
  ...
  @Test
  public void parseBlackStartsWithEnPassant() throws IOException, MorphyException {
    ByteBuffer buf =
        ResourceLoader.loadResource(MoveSerializerTest.class, "blackstartswithep.moves.bin");
    GameMovesModel model = movesSerializer.deserializeMoves(buf);
  ...
  @Test
  public void serializeDeserializeEmptyGame() throws MorphyMoveDecodingException {
  ...
  @Test
  public void serializeDeserializeGeneratedGames() throws MorphyInvalidDataException {
  ...
  @Test
  public void parseSpecialEncoding() throws IOException, MorphyException {
    // This is mode 5
    GameMovesModel model =
        movesSerializer.deserializeMoves(
            ResourceLoader.loadResource(MoveSerializerTest.class, "specialencoding.moves.bin"));
    String expected =
        "1.Nf3 f5 2.d4 e6 3.Bf4 d5 4.e3 Nf6 5.Bd3 c6 6.O-O Be7 7.Nbd2 O-O 8.c4 "
  ...
  @Test
  public void serializeDeserializeCrazyGame() throws MorphyMoveDecodingException {
  ...
  @Test
  public void serializeDeserializeSetupPositionGame() throws MorphyMoveDecodingException {
    // Serializes and deserializes a game in all supported modes
  ...
  @Test
  public void serializeDeserializeVariationsGame() throws MorphyMoveDecodingException {
    // Serializes and deserializes a game in all supported modes
    // that has variations
  ...
  @Test
  public void deserializeBrokenChess960Game() throws IOException, MorphyMoveDecodingException {
    // Game 3730252 in Mega Database 2016
    GameMovesModel model =
        movesSerializer.deserializeMoves(
            ResourceLoader.loadResource(MoveSerializerTest.class, "brokenchess960.moves.bin"));
    String expected =
        "1.b3 b6 2.e4 e5 3.Nf3 f6 4.Bc4 Bc5 5.Qf1 Ne7 6.O-O-O Nbc6 7.Ba6 Rb8 8.Bc4 Qf8 9.Nc3 Nd4 10.Nxd4 Bxd4 11.Kb1 Nc8 12.f4 Nd6 13.Bd3 b5 14.Nxb5 Nxb5 15.Bxb5 Bxa1 16.Kxa1 exf4 17.Qd3 Qd6 18.Qxd6 cxd6 19.Bd3 f5 20.exf5 Bxg2 21.Rg1 f3 22.Bf1 O-O 23.Bxg2 fxg2 24.Rxg2 Rxf5 25.Rg4 Kf7 26.Kb2 g5 27.Rd4 Rb6 28.h4 h6 29.hxg5 hxg5 30.Rh1 Kg7 31.c4 d5 32.c5 Rc6 33.b4 d6 34.cxd6 Rxd6 35.a4 a6 36.Kc3 Rb6 37.b5 axb5 38.a5 Rc6+ 39.Kb4 Rc4+ 40.Rxc4 bxc4 41.a6 Rf8 42.Kc5 Kg6 43.a7 g4 44.Kxd5 Ra8 45.Ra1 g3 46.Kc6 Kf5 47.Kb7 Rxa7+ 48.Rxa7 Ke4 49.Ra3 Kf4 50.Rc3";
    assertEquals(expected, model.toString());

    // Game 3730254 in Mega Database 2016
    model =
        movesSerializer.deserializeMoves(
            ResourceLoader.loadResource(MoveSerializerTest.class, "brokenchess960_2.moves.bin"));
    expected =
        "1.c4 c5 2.b3 b6 3.Nf3 e6 4.d4 cxd4 5.Nxd4 Nc6 6.Nf3 Be7 7.Nc3 O-O 8.g3 Nf6 9.Bg2 Nb4 10.O-O d5 11.a3 Na6 12.cxd5 Nxd5 13.b4 Nxc3 14.Bxc3 Rxd1 15.Rxd1 Rd8 16.Rxd8+ Bxd8 17.Qb2 f6 18.Bh3 Nc7 19.Nd4 Qd7 20.Bg4 f5 21.Bf3 Nd5 22.Qb3 Nxc3 23.Qxc3 Bf6 24.Bxa8 Bxd4 25.Qd3 Qd8 26.Bb7 Kf7 27.Ba6 Bf6 28.Qb3 Ke7 29.Bc4 Qd6 30.Qf3 Be5 31.Bb3 Kf6 32.h4 Bb2 33.g4 Bxa3 34.Qc3+ Kg6 35.h5+ Kh6 36.g5+ Kxh5 37.Qxg7 Kg4 38.g6 h5 39.Qc3";
    assertEquals(expected, model.toString());
  }

  @Test
  public void serializeDeserializeChess960Game() throws MorphyMoveDecodingException {
  ...
  @Test
  public void serializeDeserializeGameWithNullMove() throws MorphyMoveDecodingException {
  ...
  public void serializeSetupPosition() {
    ...
    String expected =
        "01 00 00 3C 00 01 20 00 F0 0B 78 5A CD 08 8F 01 97 80 00 00 00 00 00 00 00 00 00 00 ";
  ...
  /*
     @Test
     public void reserializeManyGames() throws MorphyException {
     ...
     // TODO: Restore this test when all code is in place
  */
}
