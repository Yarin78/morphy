...
public class MoveSerializerTest {
    ...
    public void parseSpecialMoves() throws IOException, MorphyException {
        ByteBuffer buf = ResourceLoader.loadResource(MoveSerializerTest.class,"specialmoves.moves.bin");
        GameMovesModel model = movesSerializer.deserializeMoves(buf);
    ...
    public void parseManyIdenticalPieces() throws IOException, MorphyException {
        ByteBuffer buf = ResourceLoader.loadResource(MoveSerializerTest.class, "manyidenticalpieces.moves.bin");
        GameMovesModel model = movesSerializer.deserializeMoves(buf);
    ...
    public void parseMoreIdenticalPieces() throws IOException, MorphyException {
        ByteBuffer buf = ResourceLoader.loadResource(MoveSerializerTest.class, "moreidenticalpieces.moves.bin");
        GameMovesModel model = movesSerializer.deserializeMoves(buf);
    ...
    public void parsePawnPromotions() throws IOException, MorphyException {
        ByteBuffer buf = ResourceLoader.loadResource(MoveSerializerTest.class, "pawnpromotions.moves.bin");
        GameMovesModel model = movesSerializer.deserializeMoves(buf);
    ...
    public void parseBlackStartsWithEnPassant() throws IOException, MorphyException {
        ByteBuffer buf = ResourceLoader.loadResource(MoveSerializerTest.class, "blackstartswithep.moves.bin");
        GameMovesModel model = movesSerializer.deserializeMoves(buf);
    ...
    public void parseSpecialEncoding() throws IOException, MorphyException {
        // This is mode 5
        GameMovesModel model = movesSerializer.deserializeMoves(ResourceLoader.loadResource(MoveSerializerTest.class, "specialencoding.moves.bin"));
    ...
    public void deserializeBrokenChess960Game() throws IOException, MorphyMoveDecodingException {
        ...
        GameMovesModel model = movesSerializer.deserializeMoves(ResourceLoader.loadResource(MoveSerializerTest.class, "brokenchess960.moves.bin"));
        ...
        model = movesSerializer.deserializeMoves(ResourceLoader.loadResource(MoveSerializerTest.class, "brokenchess960_2.moves.bin"));
