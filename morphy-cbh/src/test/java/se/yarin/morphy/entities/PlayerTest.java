...
public class PlayerTest {
  ...
  public void setupEntityTest() throws IOException {
    playerIndexFile =
        ResourceLoader.materializeStream(
            "entity_test", GameHeaderIndex.class.getResourceAsStream("entity_test.cbp"), ".cbp");
    playerIndexSmallHeaderFile =
        ResourceLoader.materializeStream(
            "small_header", GameHeaderIndex.class.getResourceAsStream("small_header.cbp"), ".cbp");
  }
  ...
  public void testGetAscendingRangeOfPlayers() throws IOException {
    ...
    List<Player> list =
        txn.streamOrderedAscending(Player.of("M", ""), null).limit(3).collect(Collectors.toList());
  ...
  public void testGetAscendingRangeOfPlayersWithExclusiveEnd() throws IOException {
    ...
    EntityIndexReadTransaction<Player> txn = playerIndex.beginReadTransaction();
    List<Player> list =
        txn.streamOrderedAscending(
                Player.of("Machelett", "Heiko"), Player.of("Maiwald", "Jens Uwe"))
  ...
  public void testGetDescendingRangeOfPlayers() throws IOException {
    ...
    EntityIndexReadTransaction<Player> txn = playerIndex.beginReadTransaction();
    List<Player> list =
        txn.streamOrderedDescending(Player.of("Sp", ""), null)
            .limit(3)
            .collect(Collectors.toList());
    assertEquals(3, list.size());
  ...
  public void testPlayerSortingOrder() {
    ...
    String[] playerNames =
        new String[] {
          "", "A", "B", "Blo", "Blö", "Jimmy", "Zoo", "ceasar", "moo", "tjo", "¤", "Åland", "É",
          "Öland", "Û"
        };
