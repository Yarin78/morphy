...
public class FooEntityIndex extends EntityIndex<FooEntity> {
  ...
  public static @NotNull FooEntityIndex open(@NotNull File file, @NotNull Set<OpenOption> options)
    ...
    return new FooEntityIndex(
        new FileItemStorage<>(
            ...
            new DatabaseContext(),
            "Foo",
            new EntityIndexSerializer(SERIALIZED_FOO_SIZE),
            EntityIndexHeader.empty(SERIALIZED_FOO_SIZE),
            options));
  }
  ...
  public static @NotNull FooEntityIndex openInMemory(
