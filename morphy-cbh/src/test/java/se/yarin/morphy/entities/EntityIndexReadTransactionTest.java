...
public class EntityIndexReadTransactionTest {
  ...
  public void testStreamOrderedAscending() {
    ...
    String result = txn.streamOrderedAscending().map(FooEntity::key).collect(Collectors.joining());
    assertEquals("abcdelqtvw", result);

    result =
        txn.streamOrderedAscending(FooEntity.of("f"), null)
            .map(FooEntity::key)
            .collect(Collectors.joining());
    assertEquals("lqtvw", result);

    result =
        txn.streamOrderedAscending(FooEntity.of("q"), null)
            .map(FooEntity::key)
            .collect(Collectors.joining());
  ...
  public void testAscendingStreamOverSingleNodeIndex() {
    ...
    // No start marker
    assertEquals(
        "e", txn.streamOrderedAscending().map(FooEntity::key).collect(Collectors.joining()));

    // Start before first
    assertEquals(
        "e",
        txn.streamOrderedAscending(FooEntity.of("b"), null)
            .map(FooEntity::key)
            .collect(Collectors.joining()));
    ...
    assertEquals(
        "e",
        txn.streamOrderedAscending(FooEntity.of("e"), null)
            .map(FooEntity::key)
            .collect(Collectors.joining()));
    ...
    assertEquals(
        "",
        txn.streamOrderedAscending(FooEntity.of("g"), null)
            .map(FooEntity::key)
            .collect(Collectors.joining()));
  }
  ...
  public void testAscendingStreamInEmptyRange() {
    ...
    assertEquals(
        "",
        txn.streamOrderedAscending(FooEntity.of("e"), FooEntity.of("e"))
            .map(FooEntity::key)
            .collect(Collectors.joining()));
    assertEquals(
        "",
        txn.streamOrderedAscending(FooEntity.of("n"), FooEntity.of("d"))
            .map(FooEntity::key)
            .collect(Collectors.joining()));
    assertEquals(
        "",
        txn.streamOrderedAscending(FooEntity.of("n"), FooEntity.of("f"))
            .map(FooEntity::key)
            .collect(Collectors.joining()));
  }
  ...
  public void testOrderedDescendingStream() {
    ...
    assertEquals(
        "wvtqledcba",
        txn.streamOrderedDescending().map(FooEntity::key).collect(Collectors.joining()));

    assertEquals(
        "edcba",
        txn.streamOrderedDescending(FooEntity.of("f"), null)
            .map(FooEntity::key)
            .collect(Collectors.joining()));

    assertEquals(
        "qledcba",
        txn.streamOrderedDescending(FooEntity.of("q"), null)
            .map(FooEntity::key)
            .collect(Collectors.joining()));

    assertEquals(
        "wvtql",
        txn.streamOrderedDescending((FooEntity) null, FooEntity.of("f"))
            .map(FooEntity::key)
            .collect(Collectors.joining()));

    assertEquals(
        "qled",
        txn.streamOrderedDescending(FooEntity.of("q"), FooEntity.of("c"))
            .map(FooEntity::key)
            .collect(Collectors.joining()));
  }
  ...
  public void testDescendingStreamInEmptyRange() {
    ...
    assertEquals(
        "",
        txn.streamOrderedDescending(FooEntity.of("e"), FooEntity.of("e"))
            .map(FooEntity::key)
            .collect(Collectors.joining()));
    assertEquals(
        "",
        txn.streamOrderedDescending(FooEntity.of("d"), FooEntity.of("n"))
            .map(FooEntity::key)
            .collect(Collectors.joining()));
    assertEquals(
        "",
        txn.streamOrderedDescending(FooEntity.of("d"), FooEntity.of("q"))
            .map(FooEntity::key)
            .collect(Collectors.joining()));
  }
  ...
  public void testStreamWithDuplicateEntries() {
    ...
    assertEquals(
        "abbcdeeelqtvwx",
        txn.streamOrderedAscending().map(FooEntity::key).collect(Collectors.joining()));
    assertEquals(
        "xwvtqleeedcbba",
        txn.streamOrderedDescending().map(FooEntity::key).collect(Collectors.joining()));
  }
  ...
  public void testStreamWithFilter() {
    ...
    EntityFilter<FooEntity> fooFilter =
        new EntityFilter<>() {
          @Override
