...
public class ASFScriptCommandReaderTest {
  ...
  public void readFromNonASFFile() throws IOException {
    ASFScriptCommandReader reader =
        new ASFScriptCommandReader(getClass().getResourceAsStream("notasf.txt"));
    reader.init();
  }
  ...
  public void readFromFileWithNoScriptCommands() throws IOException {
    ASFScriptCommandReader reader =
        new ASFScriptCommandReader(getClass().getResourceAsStream("noscriptcommands.wmv"));
    int cnt = reader.init();
  ...
  public void callInitAndValidateNumberOfScriptCommands() throws IOException {
    ASFScriptCommandReader reader =
        new ASFScriptCommandReader(getClass().getResourceAsStream("asfheaderonly.wmv"));
    int cnt = reader.init();
