...
/**
 * An event that updates a {@link se.yarin.chess.NavigableGameModel}. Events should be immutable.
 */
public abstract class GameEvent {
  ...
  /**
   * @return true if this event incrementally updates the game model; false if the entire game model
   *     is changed
   */
