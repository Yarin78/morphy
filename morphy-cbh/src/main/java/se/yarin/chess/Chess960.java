...
public final class Chess960 {
    ...
    private final static String kingsTable[] = new String[] {
    ...
    private final static String bishopsTable[] = new String[] {
        "BB------","B--B----","B----B--","B------B",
        "-BB-----","--BB----","--B--B--","--B----B",
        "-B--B---","---BB---","----BB--","----B--B",
        "-B----B-","---B--B-","-----BB-","------BB"
    ...
    public final static int REGULAR_CHESS_SP = 518;
     ...
     * @param firstRank an eight character string representing the pieces on the first rank (case insensitive)
