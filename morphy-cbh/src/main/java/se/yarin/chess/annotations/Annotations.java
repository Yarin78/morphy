...
public class Annotations extends ArrayList<Annotation> {
    ...
    /**
     * Replaces an annotation. Any annotations of the same class as annotation
     * will be removed.
    ...
    /**
     * Gets an annotation of the specified class. If there are multiple
     * annotations with the class, the first instance will be returned.
