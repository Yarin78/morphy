...
public class AnnotatorIndex extends EntityIndex<Annotator> {
  ...
  public AnnotatorIndex(@Nullable DatabaseContext context) {
    this(
        new InMemoryItemStorage<>(
            context, "Annotator", EntityIndexHeader.empty(SERIALIZED_ANNOTATOR_SIZE)),
        context);
  }

  protected AnnotatorIndex(
    ...
    this(
        new FileItemStorage<>(
            ...
            context,
            "Annotator",
            new EntityIndexSerializer(SERIALIZED_ANNOTATOR_SIZE),
            EntityIndexHeader.empty(SERIALIZED_ANNOTATOR_SIZE),
            openOptions),
        context);
  }
  ...
  public static @NotNull AnnotatorIndex create(
      @NotNull File file, @Nullable DatabaseContext context)
      throws IOException, MorphyInvalidDataException {
    return new AnnotatorIndex(
  ...
  public static @NotNull AnnotatorIndex open(
