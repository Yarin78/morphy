...
// The same numbering scheme is used by ChessBase to enumerate languages, even though only a few are
// used
public enum Nation {
  NONE("none", ""),
   ...
   */
  public static Nation fromName(@NotNull String name) {
   ...
   * @return a Nation, or {@link Nation#NONE} if there is no match
   */
  public static Nation fromIOC(@NotNull String ioc) {
