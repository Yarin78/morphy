...
public class SourceIndex extends EntityIndex<Source> {
  ...
  public SourceIndex(@Nullable DatabaseContext context) {
    this(
        new InMemoryItemStorage<>(
            context, "Source", EntityIndexHeader.empty(SERIALIZED_SOURCE_SIZE)),
        context);
  }
  ...
  protected SourceIndex(
    ...
    this(
        new FileItemStorage<>(
            ...
            context,
            "Source",
            new EntityIndexSerializer(SERIALIZED_SOURCE_SIZE),
            EntityIndexHeader.empty(SERIALIZED_SOURCE_SIZE),
            openOptions),
        context);
  }
  ...
  public static @NotNull SourceIndex open(
