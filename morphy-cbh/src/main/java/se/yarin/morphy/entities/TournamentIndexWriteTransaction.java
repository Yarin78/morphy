...
public class TournamentIndexWriteTransaction extends EntityIndexWriteTransaction<Tournament>
  ...
  public TournamentIndexWriteTransaction(
    ...
    super.commit(
        () -> {
          if (tournamentExtraStorage != null) {
            // Don't put extra elements if 1) they contain no data and 2) is beyond the end of the
            // file
  ...
  public int addEntity(@NotNull Tournament entity, @Nullable TournamentExtra extra) {
    if (extra != null && tournamentExtraStorage == null) {
      throw new IllegalArgumentException(
          "Tried to modify TournamentExtra without a storage reference");
    }
  ...
  public void putEntityById(
      int tournamentId, @NotNull Tournament entity, @Nullable TournamentExtra extra) {
    if (extra != null && tournamentExtraStorage == null) {
      throw new IllegalArgumentException(
          "Tried to modify TournamentExtra without a storage reference");
    }
