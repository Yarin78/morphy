...
public enum MorphyOpenOption implements OpenOption {
  /**
   * By default any kind of invalid data encountered will cause exceptions. By specifying this flag,
   * non-critical errors will be ignored and empty data (or similar) will be returned. This can not
   * be used in combination with {@link java.nio.file.StandardOpenOption#WRITE}
   */
