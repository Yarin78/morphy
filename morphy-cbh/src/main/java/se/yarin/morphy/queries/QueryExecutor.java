...
public class QueryExecutor<T> {
    ...
    public QueryExecutor(@NotNull DatabaseReadTransaction transaction, @Nullable Consumer<T> progressUpdater) {
    ...
    public QueryResult<T> execute(@NotNull ItemQuery<T> query, int limit, boolean countAll) {
        ...
        searchStream.forEachOrdered(item -> {
     ...
     */
    public QueryResult<T> execute(@NotNull ItemQuery<T> query, int limit, boolean countAll, @NotNull Consumer<T> consumer) {
