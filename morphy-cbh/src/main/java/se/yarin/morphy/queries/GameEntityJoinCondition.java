...
public enum GameEntityJoinCondition {
    ...
    public boolean matches(int whiteId, int blackId, @NotNull GameResult result, @NotNull Set<Integer> matchingIds) {
        return switch (this) {
    ...
    public int[][] getJoinIds(@NotNull Game data, @NotNull EntityType entityType) {
        ...
        if ((entityType == EntityType.PLAYER || entityType == EntityType.TEAM) && (this == GameEntityJoinCondition.ANY || this == GameEntityJoinCondition.BOTH)) {
