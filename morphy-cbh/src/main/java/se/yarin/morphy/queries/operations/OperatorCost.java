...
public abstract class OperatorCost {
  ...
  @Value.Default
  public long estimateDeserializations() {
    return 0;
  }

  @Value.Default
  public long estimatePageReads() {
    return 0;
  }
  ...
  @Value.Default
  public long actualDeserializations() {
    return 0;
  }

  @Value.Default
  public long actualPhysicalPageReads() {
    return 0;
  }

  @Value.Default
  public long actualLogicalPageReads() {
    return 0;
  }

  @Value.Default
  public boolean actualIsDuplicate() {
    return false;
  }
