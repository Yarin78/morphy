...
public class EntityIdsByGames<T extends Entity & Comparable<T>> extends QueryOperator<T> {
    ...
    public EntityIdsByGames(@NotNull QueryContext queryContext, @NotNull EntityType entityType, @NotNull QueryOperator<Game> source, @Nullable GameEntityJoinCondition joinCondition) {
