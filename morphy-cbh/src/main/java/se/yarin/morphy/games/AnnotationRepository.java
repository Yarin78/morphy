...
public class AnnotationRepository implements BlobSizeRetriever {
  ...
  public static AnnotationRepository create(@NotNull File file, @Nullable DatabaseContext context)
      throws IOException {
   ...
   */
  public static AnnotationRepository open(@NotNull File file, @Nullable DatabaseContext context)
      throws IOException {
   ...
   * @throws IOException if something went wrong when opening the repository
   */
  public static AnnotationRepository open(
  ...
  /**
   * Loads an annotation repository from file into an in-memory storage. Any writes to the
   * repository will not be persisted to disk.
   *
   ...
   * @param ofs the old offset where annotations of this game was stored, or 0 if no annotations
   *     were stored for this game before
  ...
  public int preparePutBlob(
      long currentAnnotationOffset, long targetAnnotationOffset, GameMovesModel model) {
