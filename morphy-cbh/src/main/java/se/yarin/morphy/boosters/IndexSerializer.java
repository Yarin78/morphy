...
public class IndexSerializer implements ItemStorageSerializer<IndexHeader, IndexItem> {
  ...
  @Override
  public @NotNull IndexItem deserializeItem(
      int id, @NotNull ByteBuffer buf, @NotNull IndexHeader header) {
  ...
  public void serializeItem(
      @NotNull IndexItem indexItem, @NotNull ByteBuffer buf, @NotNull IndexHeader header) {
