 ...
 *
 * <p>expression -> logical_or logical_or -> logical_and ( "||" logical_and )* logical_and ->
 * equality ( "&&" equality )* bitwise_or -> bitwise_xor ( "|" bitwise_xor )* bitwise_xor ->
 * bitwise_and ( "^" bitwise_and )* bitwise_and -> equality ( "&" equality )* equality -> comparison
 * ( ( "!=" | "==" ) comparison )* comparison -> term ( ( ">" | ">=" | "<" | "<=" ) term )* term ->
 * factor ( ( "-" | "+" ) factor )* factor -> unary ( ( "/" | "*" ) unary )* unary -> ( "!" | "-" |
 * "~" ) unary | primary function -> identifier "(" expression ")" primary -> INTEGER | true | false
 * | function | "(" expression ")"
 */
public class Parser {
