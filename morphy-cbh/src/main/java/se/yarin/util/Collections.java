...
public class Collections {
  /**
   * Generates all permutations of a list of elements. If the input list has n elements, the output
   * list will have n! elements. In particular, if the input list is empty, the output list will
   * contain a single empty list.
   *
