...
public class PositionTest {
  ...
  public void testQueenMoves() {
    ...
    verifyToSquares(
        position.generateQueenMoves(B7),
        B7,
        B6,
        B5,
        B8,
  ...
  public void testCastleMoves() {
    Position position =
        Position.fromString(
            "r...k..r\n" + "........\n" + "......K.\n",
            BLACK,
            EnumSet.of(BLACK_SHORT_CASTLE, BLACK_LONG_CASTLE),
            NO_COL);
  ...
  public void testNullMoveDoMove() {
    Position position = Position.fromString("....k...\n" + "K.......\n", WHITE);
    assertEquals(WHITE, position.playerToMove());
  ...
  public void testIsCheck() {
    ...
    position = Position.fromString("..K.k..r\n" + "........\n" + ".n......\n", WHITE);
    assertTrue(position.isCheck());
    ...
    position = Position.fromString("R..rk...\n" + "........\n" + "K.......\n", BLACK);
    assertFalse(position.isCheck());
  }
  ...
  public void testIsMate() {
    Position position = Position.fromString("R.....k.\n" + ".K...ppp\n" + "........\n", BLACK);
    assertTrue(position.isMate());
    assertFalse(position.isStaleMate());

    position = Position.fromString("R.....k.\n" + ".K...ppp\n" + "..r.....\n", BLACK);
  ...
  public void testIsStaleMate() {
    ...
    position = Position.fromString("k..\n" + ".R.\n" + "p.K\n", BLACK);
    assertFalse(position.isStaleMate());
  }
  ...
  public void testChess960Castles() {
    ...
    assertEquals(
        "..krr...", position.doMove(Move.longCastles(position)).toString().substring(0, 8));
    assertEquals(
        "r....rk.", position.doMove(Move.shortCastles(position)).toString().substring(0, 8));
    ...
    assertEquals(
        "nnkr...r", position.doMove(Move.longCastles(position)).toString().substring(0, 8));
