...
public class GameMovesModelTest {
  ...
  public void testSetupPositionWhiteToMove() {
    ...
    GameMovesModel model =
        new GameMovesModel(
            Position.fromString(startPos, Player.WHITE, EnumSet.allOf(Castles.class), -1), 3);
  ...
  public void testSetupPositionBlackToMove() {
    ...
    GameMovesModel model =
        new GameMovesModel(
            Position.fromString(startPos, Player.BLACK, EnumSet.allOf(Castles.class), -1), 3);
