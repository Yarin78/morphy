...
rating it is, at what time control, and what it is called. See FORMAT.md.
...
from morphy.nations import decode_nation
...
class RatingType:
    ...
    subtype: int  # which rating list this is; see FORMAT.md
